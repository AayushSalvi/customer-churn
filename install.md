# customer_churn guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `customer_churn/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `customer_churn` folder and use the modules inside your notebooks :
...
```python
from customer_churn.utils.paths import data_dir
data_dir()
```
